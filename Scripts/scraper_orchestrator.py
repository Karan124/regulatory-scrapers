...
=================================================="""
    ...
    def get_default_regulators(self) -> List[Tuple]:
        ...
        return [
            ...
            ("APRA Consultations", "APRA", ["apra_consultations_scrape.py"], 1500, "giant"),
            ...
            ("ACMA Media Releases", "ACMA", ["acma_all_media_releases_scrape.py"], 480, "complex"),
            ...
            ("TRANSPARENCY_AU", "TRANSPARENCY_AU", None, 480, "complex"),
           ...
           # ("RBNZ News and Events", "RBNZ", ["rbnz_news_and_events_scrape.py"], 480, "complex"),  
            ...
            ("TREASURYNZ News", "TREASURYNZ", ["treasuryNZ_news_scrape.py"], 900, "heavy"),
            ("RBNZ News", "RBNZ", ["rbnz_news_scrape.py"], 300, "standard"),
            ("RBNZ Publications", "RBNZ", ["rbnz_publications_scrape.py"], 300, "standard"),
            ("RBNZ Consultations", "RBNZ", ["rbnz_consultations_scrape.py"], 480, "complex"),
        ]
